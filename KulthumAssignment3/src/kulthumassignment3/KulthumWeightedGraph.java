...
/**
 *
 * This class extends KulthumUnweightedGraph class
 * with 5 constructors for creating concrete KulthumWeightedGraph instances.
 */
public class KulthumWeightedGraph<V> extends KulthumUnweightedGraph<V> 
{
    // Construct an empty 
    public KulthumWeightedGraph() 
    {
    }


    // Construct a WeightedGraph from vertices and edged in arrays 
    public KulthumWeightedGraph(V[] vertices, int[][] edges) 
    {
        createKulthumWeightedGraph(java.util.Arrays.asList(vertices), edges);
    }


    // Construct a WeightedGraph from vertices and edges in list
    public KulthumWeightedGraph(int[][] edges, int numberOfVertices) 
    {
        List<V> vertices = new ArrayList<>();
        for (int i = 0; i < numberOfVertices; i++)
          vertices.add((V)(new Integer(i)));

        createKulthumWeightedGraph(vertices, edges);
    }


    // Construct a WeightedGraph for vertices 0, 1, 2 and edge list 
    public KulthumWeightedGraph(List<V> vertices, List<WeightedEdge> edges) 
    {
        createKulthumWeightedGraph(vertices, edges);
    }
    ...
    public KulthumWeightedGraph(List<WeightedEdge> edges, int numberOfVertices) 
    {
        List<V> vertices = new ArrayList<>();
        for (int i = 0; i < numberOfVertices; i++)
          vertices.add((V)(new Integer(i)));
    ...
    private void createKulthumWeightedGraph(List<V> vertices, int[][] edges) 
    {
    ...
    private void createKulthumWeightedGraph(
