...
/**
 *
 * A concrete class that implements the KulthumGraph interface.
 */
public class KulthumUnweightedGraph<V> implements KulthumGraph<V> 
{
    ...
    protected KulthumUnweightedGraph() 
    {
    }


    // Construct a graph from vertices and edges stored in arrays 
    protected KulthumUnweightedGraph(V[] vertices, int[][] edges) 
    {
    ...
    protected KulthumUnweightedGraph(List<V> vertices, List<Edge> edges) 
    {
    ...
    protected KulthumUnweightedGraph(List<Edge> edges, int numberOfVertices) 
    {
    ...
    protected KulthumUnweightedGraph(int[][] edges, int numberOfVertices) 
    {
        for (int i = 0; i < numberOfVertices; i++) 
            addVertex((V)(Integer.valueOf(i))); // vertices is {0, 1, ...}
        createAdjacencyLists(edges, numberOfVertices);
    ...
    // Tree inner class inside the KUlthumUnweightedGraph class 
